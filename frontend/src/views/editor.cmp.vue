<template>
    <section class="editor-container flex column" :class="isEditorShown">
        <editor-dashboard v-if="currWap" :wapTree="wapTree" :samples="samples" :cmpToEdit="currCmpToEdit" @switchedTab="emptyCmpToEdit" @focusedCmp="setCmpToEdit" @vidChanged="setChangedVid" @mapZoomChanged="emitChangedZoom" @saveWap="saveWap">
