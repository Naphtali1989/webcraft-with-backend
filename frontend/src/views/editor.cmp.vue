...
export default {
    ...
    methods: {
        ...
        async saveWap(isFirstCollab = true) {
            if (!this.currWap.title) this.currWap.title = 'Temp Title'
            if (!this.currWap.thumbnail) this.currWap.thumbnail = 'https://imagizer.imageshack.com/img922/1531/TsEMz2.png'
