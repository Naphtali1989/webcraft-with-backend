<template>
    <section class="user-details-container" v-if="loggedInUser">
        <nav class="user-dashboard">
            <div class="logo">
                <i class="fas fa-user-circle" v-if="!loggedInUser.imgUrl"></i>
                <img v-else :src="loggedInUser.imgUrl" />
            </div>
            <ul class="sidebar-modal-links clean-list">
                <li>
                    <i class="fas fa-user-alt"></i> {{ loggedInUser.username }}
                </li>
                <li>
                ...
                <li>
                    <span>
                        ...
                        Published Websites: {{ ownerWaps.length }}
                    </span>
                </li>
                <li>
                    <label class="user-input input-file">
                        ...
                        ></span>
                        <input class="hidden" type="file" @change="setAvatar" />
        ...
        <div class="main-content-page">
            ...
            <user-msgs :msgs="dataToTransfer" @deleteMsgs="onDeleteMsgs" />
        </div>
    </section>
</template>
...
export default {
    ...
    computed: {
        ...
        dataToTransfer() {
            ...
            const msgs = data.reduce((acc,wap)=>{
                wap.reviews.forEach(review=> acc.push(review))
                return acc
            },[])
