<template>
    <section class="container flex align-center justify-center">
        <div class="flex align-center justify-center screen" @click="closeModal"></div>
        <section class="signup-modal">
            <div class="forms-container flex">
                ...
                <svg xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                        <linearGradient id="paint0_linear" x1="1038.17" y1="-8.72305" x2="223.672" y2="689.277" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#38D39F" />
                            <stop offset="1" stop-color="#38A4D3" />
                        </linearGradient>
                    </defs>
                </svg>
                <img src="@/assets/img/signup-2.svg" class="svg-img" />
            </div>
            <button @click="closeModal" class="btn close-btn"><i class="fas fa-times"></i></button>
        </section>
    </section>
</template>
