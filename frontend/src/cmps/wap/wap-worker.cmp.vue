<template>
    ...
    <component class="worker-class" :info="getInfo" :id="'el-' + workerHoverClass" :frameborder="0" :is="name" :src="urlSrc" :contenteditable="editable" :allowfullscreen="video" :style="cmp.style" :class="cmp.class" :placeholder="cmp.placeholder" @blur="updateTxt" @focused="onFocus" @ondragstart="imgDraggable" @click.stop.prevent="onFocus(cmp._id)">
        ...
        <div class="site-video" slot="video-control" v-if="
                cmp.class === 'video-container' || cmp.class === 'map-container'
            ">
